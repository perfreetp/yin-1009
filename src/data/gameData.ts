...
export const NEGOTIATION_EVENTS = [
  {
    id: 'neg_crop',
    title: '庄稼受损纠纷',
    description: '野猪群昨夜闯入农田，糟蹋了王大叔家三亩即将成熟的玉米地。王大叔情绪激动，要求巡护队赔偿损失，并扬言要上山投毒杀野猪。',
    villagerName: '王大叔',
    conflictType: 'crop_damage' as const,
    stanceOptions: ['empathetic' as const, 'pragmatic' as const, 'educational' as const],
    resolved: false,
    icon: '🌽',
    villagerQuote: '这是我全家半年的口粮啊！你们不让我杀野猪，那损失谁来赔？要么赔粮，要么让我上山去！',
  },
  {
    id: 'neg_livestock',
    title: '牲畜遇袭事件',
    description: '凌晨时分，疑似金钱豹潜入羊圈咬死了李婶家的 4 只山羊。李婶抱着死羊坐在保护站门口哭泣，围观村民群情激愤。',
    villagerName: '李婶',
    conflictType: 'livestock' as const,
    stanceOptions: ['empathetic' as const, 'pragmatic' as const, 'strict' as const],
    resolved: false,
    icon: '🐐',
    villagerQuote: '这些羊是我孙儿的学费钱啊！那豹子不除，以后全村的牲口都别想安生！我知道它的窝在哪！',
  },
  {
    id: 'neg_encroach',
    title: '林地侵占争议',
    description: '赵哥带着几家人在保护区边界砍伐林木、开垦坡地，打算种几亩药材增加收入。此处正是金钱豹迁徙的重要廊道。',
    villagerName: '赵哥',
    conflictType: 'encroachment' as const,
    stanceOptions: ['strict' as const, 'educational' as const, 'pragmatic' as const],
    resolved: false,
    icon: '⛏️',
    villagerQuote: '我爷爷的爷爷就在这儿种庄稼了！现在说这是保护区不让种？那我们一家人喝西北风去？',
  },
  {
    id: 'neg_tradition',
    title: '传统狩猎节冲突',
    description: '村里即将举办三年一度的「山祭」，按传统要组织年轻人上山狩猎三天。张村长认为这是传承数百年的习俗，不应被取消。',
    villagerName: '张村长',
    conflictType: 'tradition' as const,
    stanceOptions: ['empathetic' as const, 'educational' as const, 'pragmatic' as const],
    resolved: false,
    icon: '🏮',
    villagerQuote: '山祭是我们对山神的敬畏！老祖宗传了十几代的规矩，到我这儿不能断了，否则全村要遭殃的！',
  },
]
